    ...
    <div class="container">
      ...
      <div class="setting-wrapper">
        <p class="path font-12">
          ...
          <router-link tag="span" to="/bobil" class="blue-text underlined">Bobil</router-link>
        </p>
...
export default {
  ...
  computed: {
    ...
    _filteredProducts() {
      return this.$store.state.products && this.$store.state.products.filter(product => {
  ...
  mounted() {
    if (!this.$store.products) this.$store.dispatch("FETCH_RV_DATA");
