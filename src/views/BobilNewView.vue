    ...
    <div class="container">
      ...
      <div class="setting-wrapper">
        <p class="path font-12">
          ...
          <i class="fa fa-caret-right"></i>
          <router-link tag="span" to="/nye-bobiler" class="blue-text underlined">Nye Bobiler</router-link>
        </p>
      </div>
      <div class="row">
  ...
  computed: {
    ...
    bobilerDescription() {
      var temp = this.$store.state.homeData.find(product => {
        return product.key == "nye_bobiler_description";
      });
    ...
    bobilerImage() {
      var temp = this.$store.state.homeData.find(product => {
        return product.key == "nye_bobiler_image";
      });
    ...
    bobilerTitle() {
      var temp = this.$store.state.homeData.find(product => {
        return product.key == "nye_bobiler_title";
      });
    ...
    metaDescription() {
      var temp = this.$store.state.homeData.find(product => {
        return product.key == "nye_meta_description";
      });
    ...
    metaTitle() {
      var temp = this.$store.state.homeData.find(product => {
        return product.key == "nye_meta_title";
      });
